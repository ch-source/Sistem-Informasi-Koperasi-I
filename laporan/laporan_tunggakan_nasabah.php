...
$pdf->SetX(1.6);
$pdf->SetFont('Times','i',10);
$pdf->MultiCell(22.5,0.6,"Laporan Sisa Angsuran: ".$penerima."/ Tahun: ".$tahun,0,'L'); 
...
$no=1;
$sql="SELECT * FROM tbl_pembayaran_pinjaman_nasabah WHERE id_nasabah='$penerima' AND tahun='$tahun'";
...
$order="SELECT * FROM tbl_pembayaran_pinjaman_nasabah WHERE id_nasabah='$penerima' AND tahun='$tahun'";
