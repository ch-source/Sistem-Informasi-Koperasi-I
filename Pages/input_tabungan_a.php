...
$query_x = "SELECT max(id_tabungan) as maxId FROM tbl_tabungan WHERE nomor='".$_POST['anggota']."'";
...
$query_nasabah="SELECT * FROM tbl_anggota_nasabah WHERE nomor='".$_POST['anggota']."'";
          ...
          <div class="row mb-12">
            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                ...
                <h6 class="m-0 font-weight-bold text-dark">Form Input Tabungan Anggota</h6><a href="dashboard.php?p=data_tabungan" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></a>
                </div>
                <div class="card-body">
                  <form method="post" action="proses_tabungan_anggota_a.php?id=<?php echo $nasabah; ?>" enctype="multipart/form-data">

                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">ID / Nama Anggota</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" name="penerima" value="<?php echo $_POST['anggota']; ?>" readonly="readonly">
                      </div>
                      <div class="col-sm-6">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="row mb-12">
            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-dark">Form Input Simpanan Wajib Anggota</h6><a href="dashboard.php?p=data_tabungan" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></a>
                </div>
                <div class="card-body">
