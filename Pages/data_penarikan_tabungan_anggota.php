        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="">Data Penarikan Tabungan Anggota Koperasi</li>
            </ol>
          </div>
            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Form Input Data Penarikan Anggota</h6>
                </div>
                <div class="card-body">
                  <form method="post" action="proses_simpan_penarikan_anggota.php" role="form" method="post">
                 <?php
                  include "koneksi.php";
              ...
              if(isset($_GET['notif'])){
                if($_GET['notif']=="berhasil"){
                  echo "<div class='alert alert-success alert-dismissible'>
                        <a style='text-decoration:none;' href='dashboard.php?p=data_penarikan_tabungan_anggota' type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</a>
