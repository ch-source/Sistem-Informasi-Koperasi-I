...
$query_nasabah="SELECT * FROM tbl_nasabah WHERE id_nasabah='$id'";
          ...
          <div class="row mb-12">
            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method="post" action="proses_tabungan_anggota.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control"  value="<?php echo $data_nasabah['nama_nasabah']; ?>" readonly="readonly">
                      </div>
                    </div>
                  <div class="form-group row">
