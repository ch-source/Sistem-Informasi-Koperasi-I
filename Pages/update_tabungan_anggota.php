          ...
          <div class="row mb-12">
            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method="post" action="proses_update_tabungan.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="<?php echo $data['bunga_ta'] ?>" name="bunga" readonly="readonly">
                      </div>
                    </div>
                    <div class="form-group row">
