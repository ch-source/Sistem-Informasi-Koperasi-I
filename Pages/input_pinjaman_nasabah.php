...
$query_anggota="SELECT * FROM tbl_nasabah WHERE id_nasabah='".$_POST['nasabah']."'";
...
<?php if ($_POST['jenis']=="BPKB Mobil"){?>        
        <div class="container-fluid" id="container-wrapper">
           <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h2 class="h4 mb-0 text-gray-800">Input Pengajuan Nasabah </h2>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Input Pengajuan Nasabah</li>
            </ol>
          </div>
          <div class="row mb-12">
            ...
            <div class="col-xl-12 col-md-6 mb-4">
               ...
               <a href="dashboard.php?p=data_pinjaman_nasabah" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="card-body">
                  <form method="post" name='autoSumForm' action="proses_simpan_pinjaman_nasabah_x.php" enctype="multipart/form-data">
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">ID Nasabah</label>
                      <div class="col-sm-4">
                       <input type="text" class="form-control" name="nim"  value="<?php echo $_POST['nasabah']; ?>" readonly="readonly">
                      </div>
                      <label class="col-sm-2 col-form-label">Nama Nasabah</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control"  value="<?php echo $data_anggota['nama_nasabah']; ?>" readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" value="<?php echo $data_anggota['no_tlpn'];?>" name="no_tlpn" readonly="readonly">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Alamat</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" value="<?php echo $data_anggota['alamat'];?>" name="alamat" readonly="readonly">
                      </div>
                      <label class="col-sm-2 col-form-label">Pekerjaan</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" value="<?php echo $data_anggota['pekerjaan'];?>" name="pekerjaan" readonly="readonly">
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" value="<?php echo $_POST['jenis'];?>" name="jenisjaminan" readonly="readonly">
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control"  name="bunga_a" id="bunga_a" readonly="readonly">
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-2">
                        <input type="text" class="form-control"  name="min" readonly="readonly" value="<?php echo $data['min'];?>">
                      </div>
                      <div class="col-sm-2">
          ...
          <div class="row mb-12">
            ...
            <div class="col-xl-12 col-md-6 mb-4">
               ...
               <a href="dashboard.php?p=data_pinjaman_nasabah" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="card-body">
                  <form method="post" name='autoSumForm' action="proses_simpan_pinjaman_nasabah_y.php" enctype="multipart/form-data">
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">ID Nasabah</label>
                      <div class="col-sm-4">
                       <input type="text" class="form-control" name="nim"  value="<?php echo $_POST['nasabah']; ?>" readonly="readonly">
