...
$query_x = "SELECT max(id_tabungan) as maxId FROM tbl_tabungan WHERE nomor='$id'";
          ...
          <div class="row mb-12">
            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                ...
                <h6 class="m-0 font-weight-bold text-dark">Form Input Tabungan Anggota</h6><a href="dashboard.php?p=data_anggota" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></a>
                </div>
                <div class="card-body">
                  <form method="post" action="proses_tabungan_anggota_a.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
