...
$query="INSERT INTO `tbl_anggota` (`id_anggota`, `nama_anggota`, `no_identitas`, `jk`, `tgl_lahir`,`tgl_pengajuan`, `alamat`, `no_tlpn`, `status`, `pekerjaan`, `status_tbngan_awal`, `status_simpanan_awal`) VALUES ('$idanggota', '$nama', '$notas', '$jk', '$tgl', '$tgp','$alt', '$notel', '$status','$pekerjaan', '', '')";
